...
// import RegionModal from '../.././Main/component/RegionModal';
// import CalendarModal from '../.././Main/component/CalendarModal';
// import PeopleModal from '../.././Main/component/PeopleModal';

// const SearchBar: React.FC<{ onSearchComplete: (region: string, date: string, adultCount: number, childCount: number) => void }> = ({ onSearchComplete }) => {
...
//     if (region !== '여행지역' && selectedDateRange) {
...
//         >
//           <span className="text-[#222222]">{selectedDateRange ? selectedDateRange : '일정'}</span>
